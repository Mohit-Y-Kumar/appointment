const BrandMark = ({ className = '', compact = false }) => {
  return (
    <div className={`inline-flex items-center gap-3 ${className}`}>
      <div className='relative flex h-9 w-9 items-center justify-center rounded-xl bg-gradient-to-br from-sky-600 to-cyan-500 shadow-sm ring-1 ring-sky-200/80'>
